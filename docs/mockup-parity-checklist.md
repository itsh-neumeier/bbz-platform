...
| 23 | contact priority blue / orange / red, call-priority animation | Epic 14 · #299, #301 | in-progress — contact priority **done** (#299): `ContactPriorityBadge.vue` = text label on the §13.9 colour (niedrig=blau/mittel=orange/hoch=rot), AA contrast, colour is a secondary cue; consistent across phone-book / quick-dial / mini-search; `ContactPriorityBadge.spec.ts`, `a11y.spec.ts` (Telefonbuch, light+dark). The waiting-queue priority colour + animated background is #301 (open) |
